<?php
    ...
    // 백엔드 코드를 화면 html코드와 함께 작성하는것이 가능함.
    // 데이터베이스의 web_board 테이블의 게시글 리스트를 읽어와서 아래 html에 표시..

    //MySQL DBMS(database management system)과 연결하여 데이터들 가져오기
    $db = mysqli_connect('localhost', 'sangukaix', 'a1s2d3f4!', 'sangukaix');//DB주소, DB접속아이디, DB접속비번, DB명
